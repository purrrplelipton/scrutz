...
function SelectTrigger({
  ...
  return (
    <Trigger
      ...
      className={cn(
        "min-h-10 border-gray-400 data-placeholder:text-gray-500 [&_svg:not([class*='text-'])]:text-gray-500 aria-invalid:ring-red-600/20 aria-invalid:border-red-600 flex w-full items-center justify-between gap-2 rounded border bg-transparent p-2.25 text-sm whitespace-nowrap shadow-xs transition-all duration-200 outline-none disabled:opacity-50 *:data-[slot=select-value]:line-clamp-1 *:data-[slot=select-value]:flex *:data-[slot=select-value]:items-center *:data-[slot=select-value]:gap-2 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4 hover:border-gray-500 focus-visible:border-teal-600 focus-visible:ring-2 focus-visible:ring-teal-600/20 data-[state=open]:border-teal-600 data-[state=open]:ring-2 data-[state=open]:ring-teal-600/20",
        className
      )}
      {...props}
    >
...
function SelectItem({
  ...
  return (
    <Item
      ...
      className={cn(
        "[&_svg:not([class*='text-'])]:text-gray-500 relative flex w-full items-center gap-2 rounded-sm py-1.5 pr-8 pl-2 text-sm outline-hidden select-none data-disabled:pointer-events-none data-disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4 *:[span]:last:flex *:[span]:last:items-center *:[span]:last:gap-2 transition-colors duration-150 hover:bg-teal-50 focus-visible:bg-teal-50 data-highlighted:bg-teal-50",
        className
      )}
      {...props}
    >
