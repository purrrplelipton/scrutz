...
export function PaginationControls({
  ...
  return (
    <div className="@container mt-11 flex items-center justify-between px-2.5 font-medium text-sm">
      <Pagination className="@md:w-auto w-full">
        <PaginationContent className="grow @md:grow-0 justify-center @md:[justify-content:auto]">
          <PaginationItem>
            <PaginationButton
