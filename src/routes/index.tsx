    ...
    <AppLayout>
      <header>
        <div className="flex items-center justify-between">
          <p className="font-bold font-general-sans text-2xl text-teal-600">Overview</p>
          <div>
            <Button type="button" variant="ghost" className="px-8 font-semibold">
        ...
        <Suspense
          fallback={
            <div className="mx-auto flex h-104 max-w-104 items-center justify-center">
              <Icon icon="svg-spinners:ring-resize" className="text-4xl text-teal-600" />
            </div>
          }
        >
          <DotLottieReact className="mx-auto max-w-104" src="/lotties/empty.lottie" loop autoplay />
        </Suspense>
